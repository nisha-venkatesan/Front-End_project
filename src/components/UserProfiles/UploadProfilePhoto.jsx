...
const UploadProfilePhoto = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      data.append("upload_preset", "livemusic"); //! Add the upload preset
      data.append("cloud_name", "dy0ohs4aw"); //! Add the Cloudinary cloud name

      //! Connect Cloudinary API and Send File => window.fetch();
      const response = await fetch(
        `https://api.cloudinary.com/v1_1/dy0ohs4aw/image/upload`,
        {
          method: "POST",
          body: data,
        }
